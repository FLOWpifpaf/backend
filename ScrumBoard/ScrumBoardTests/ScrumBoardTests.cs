...
namespace ScrumBoardTests
{
    public class ScrumBoardTests
    {
        ...
        {
            ITask task = new Task("Name", "Description task", 2);
        ...
        {
            ITask task = new Task("Name", "Description task", 3);
        ...
        {
            IColumn column = new Column("Column name");
            ITask task = new Task("Task name", "Description", 5);
        ...
        {
            IColumn column = new Column("Column name");
            ITask task = new Task("Name", "Description", 1);
        ...
        {
            IColumn column = new Column("Column name");
            ITask task = new Task("Task name", "Description task", 2);
        ...
        {
            IBoard newBoard = new Board("Board name");
        ...
        {
            IBoard board = new Board("Board name");
            ITask task = new Task("Task name", "Description", 1);
